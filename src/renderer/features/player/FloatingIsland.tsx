...
export function FloatingIsland({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-30">
      ...
      <div className="pointer-events-none absolute inset-x-3 bottom-4 flex justify-center sm:inset-x-4 sm:bottom-6 md:bottom-8">
        <div className="relative flex w-full max-w-full justify-center xl:max-w-6xl">
          <div
            className={cn(
          ...
          >
            ...
            <div className="now-playing-swap pointer-events-none relative z-10 flex min-w-0 items-center gap-3 overflow-hidden rounded-xl text-left sm:gap-4 xl:w-[min(20rem,28%)] xl:flex-none">
              <div className="h-14 w-14 shrink-0 overflow-hidden rounded-xl bg-canvas sm:h-16 sm:w-16">
                {currentArtwork ? (
                  <img
                    src={currentArtwork}
                    alt=""
