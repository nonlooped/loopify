    ...
    >
      ...
      >
        {icon ? (
          <div
            className={cn(
              "flex shrink-0 items-center justify-center rounded-[1.35rem] border border-white/10 bg-white/[0.045] text-foreground/84 shadow-[inset_0_1px_0_oklch(1_0_0_/_0.07)]",
              "transition-all duration-500 ease-out-quart hover:scale-110 hover:-rotate-6 hover:text-accent hover:shadow-lg cursor-default",
